#!/usr/bin/env python3
"""Gemma-2 cosine compression analysis — geometric layer characterization.
...
Input:  artifacts/hidden_states_advbench_gemma2/*.pt (shape: n_steps × 42 × 3584)
Output: artifacts/gemma2_cosine_compression_results.json
...
RESULTS_FILE = BASE / "artifacts" / "gemma2_cosine_compression_results.json"
...
def main():
    print(f"{'='*60}")
    print("Gemma-2 Cosine Compression Analysis")
    print(f"{'='*60}")
    ...
    output = {
        "experiment": "gemma2_cosine_compression",
        "model": "gemma-2-9b-it",
